...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-ocean-gradient text-white shadow-lg shadow-ocean-500/25 hover:shadow-xl hover:shadow-ocean-500/30 hover:-translate-y-0.5',
        destructive:
          'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline:
          'border-2 border-ocean-500 text-ocean-600 bg-background hover:bg-ocean-50',
        secondary:
          'bg-tide-500 text-white hover:bg-tide-600',
        ghost: 
          'hover:bg-ocean-50 hover:text-ocean-600',
        link: 
          'text-ocean-500 underline-offset-4 hover:underline',
      },
      size: {
